...
import static com.emmthias.cache.constants.Constants.OBJECT_URL;
...
public class CacheController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200,
                    ...
                    response = GetCacheResponse.class)})
    @PatchMapping(name = "patch", value = {CACHE_URL}, consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200,
                    message = "The element associated to cache layer identifying by key",
                    response = GetCacheResponse.class)})
    @PutMapping(name = "put", value = {CACHE_URL}, consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200,
                    ...
                    response = GetCacheResponse.class)})
    @DeleteMapping(name = "This end point will delete the object stored at slot {key}", value = {CACHE_URL},
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
